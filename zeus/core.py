...
def c2048():
    p = 
    q = (p - 1) // 2
    g0 = 
    g = pow(g0, 2, p)
    x = 
    y = pow(g, x, p)
    return p, q, g, x, y


def c4096():
    p = 
    q = (p - 1) // 2
    g0 = 
    g = pow(g0, 2, p)
    x = 
    y = pow(g, x, p)
    return p, q, g, x, y
